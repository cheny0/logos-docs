...
In Logos [Basecamp](https://docs.logos.co/get-started/glossary#basecamp), you can install and load modules that provide features like chat, storage, or wallets from the online catalogue or local `.lgx` files.
