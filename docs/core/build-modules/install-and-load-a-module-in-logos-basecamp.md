...
* [An `.lgx` file](../../build-an-app/) for local install.
...
1. In the sidebar, click **Package Manager** ![](../../build-an-app/.gitbook/assets/install-and-load-a-module-in-logos-basecamp-package-manager-icon.png).
...
4. At the bottom of the sidebar, click the **Modules** ![](../../build-an-app/.gitbook/assets/install-and-load-a-module-in-logos-basecamp-modules-icon.png). The newly installed module appears under **UI Modules** or **Core Modules** depending on its type.

### Install from a local `.lgx` file

1. At the bottom of the sidebar, click **Modules** ![](../../build-an-app/.gitbook/assets/install-and-load-a-module-in-logos-basecamp-modules-icon.png).
