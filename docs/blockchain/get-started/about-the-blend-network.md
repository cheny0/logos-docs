...
2.  The sender sends the layered message to every Blend node with which it maintains a peer-to-peer connection. This process, known as dissemination, is shown below.
    ...
    ![The Blend Network using dissemination to relay proposal messages. Peer-to-peer relaying of messages is not shown for simplicity.](../.gitbook/assets/dissemination.png)
...
![Disseminated Blend Network cover traffic (dotted lines) obscuring a data message (solid lines).](../.gitbook/assets/cover-traffic-hiding-effect.png)
